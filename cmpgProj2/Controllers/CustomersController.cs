...
using cmpgProj2.Models;
using System.Text.Json.Serialization;
using System.Text.Json;
using Microsoft.AspNetCore.Authorization;


namespace cmpgProj2.Controllers
{
    [Authorize]
    ...
    {
        private readonly newcmpgdbContext _context;

        public CustomersController(newcmpgdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
            if (_context.Customers == null)
            {
                return Problem("Entity set 'EcoPowerProject2Context.Customers'  is null.");
            }
